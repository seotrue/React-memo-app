...
const UPDATE_MEMO = 'memo/UPDATE_MEO';
const DELETE_MEMO = 'memo/DELETE';
...
// createAction 의 두번째 파라미터는 meta 데이터를 만들때 사용
...
export default handleActions({
    ...
    ...pender({
        type: UPDATE_MEMO,
        onSuccess:(state, action) =>{
            // api 호풀 시 바디에 넣어준 해당 id 데이터는 액션의 메타 값에 들어 잇다
